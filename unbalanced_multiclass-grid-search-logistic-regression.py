...
# Use 'sklearn.preprocessing.OneHotEncoder', (OneHotEncoder encoding) to feed categorical predictors (if you have any) 
#to linear models and SVMs with the standard kernels.
